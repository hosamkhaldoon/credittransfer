...
VALUES
    ...
    ('CreditTransfer:MsisdnLength', '11', 'Validation', 'Expected MSISDN length', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:RefillPinLength', '4', 'Validation', 'Expected PIN length', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:TransferFundEventId', '102', 'Business', 'Event ID for transfer fund operations', 1, GETUTCDATE(), 'System'),
    
    -- Transfer Amounts and Ranges
    ('CreditTransfer:AmountRanges', '0.1;0.5;1;3;5;10;50;100', 'Business', 'Available transfer amount ranges', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:ExtendedDaysTypes', '0;0;0;0;0;0;0', 'Business', 'Extended days for each amount range', 1, GETUTCDATE(), 'System'),
    
    -- Reason Classifications
    ('CreditTransfer:TransferMonyReasonClassification', 'POS_Transfer_0.500;POS_Transfer_0.500;POS_Transfer_1;POS_Transfer_3;POS_Transfer_5;POS_Transfer_10;POS_Transfer_50;POS_Transfer_100', 'Business', 'Transfer money reason classification', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:AdjustmentReasonClassificationFromOldToNew', 'POS_Transfer_0.500_from_oldIN_to_newIN;POS_Transfer_0.500_from_oldIN_to_newIN;POS_Transfer_1_from_oldIN_to_newIN;POS_Transfer_3_from_oldIN_to_newIN;POS_Transfer_5_from_oldIN_to_newIN;POS_Transfer_10_from_oldIN_to_newIN;POS_Transfer_50_from_oldIN_to_newIN;POS_Transfer_100_from_oldIN_to_newIN', 'Business', 'Adjustment reason for old to new transfers', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:AdjustmentReasonClassificationFromNewToOld', 'POS_Transfer_0.500_from_newIN_to_oldIN;POS_Transfer_0.500_from_newIN_to_oldIN;POS_Transfer_1_from_newIN_to_oldIN;POS_Transfer_3_from_newIN_to_oldIN;POS_Transfer_5_from_newIN_to_oldIN;POS_Transfer_10_from_newIN_to_oldIN;POS_Transfer_50_from_newIN_to_oldIN;POS_Transfer_100_from_newIN_to_oldIN', 'Business', 'Adjustment reason for new to old transfers', 1, GETUTCDATE(), 'System'),
    
    -- Customer Transfer Configuration
    ('CreditTransfer:CustomerToCustomerTransferMonyReason', 'Credit transfer', 'Business', 'Reason for customer to customer transfers', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:CustomerToCustomerAdjustmentReasonOldToNew', 'local_credit_transfer_from_oldIN_to_newIN', 'Business', 'Customer adjustment reason old to new', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:CustomerToCustomerAdjustmentReasonNewToOld', 'local_credit_transfer_from_newIN_to_oldIN', 'Business', 'Customer adjustment reason new to old', 1, GETUTCDATE(), 'System'),
    ...
    ('CreditTransfer:AdjustmentType', 'account_adjustment_action', 'Business', 'Type of adjustment action', 1, GETUTCDATE(), 'System'),
    
    -- Virgin Event Configuration  
    ('CreditTransfer:VirginEventIds', '5|1005,10|1010,15|1015,20|1020,25|1025,30|1030,35|1035,40|1040,45|1045,50|1050', 'Business', 'Virgin event IDs mapping', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:EnableExtendedDays', 'false', 'Business', 'Enable extended days (KSA) or disabled (Jordan)', 1, GETUTCDATE(), 'System'),
    
    -- MISSING: Critical configuration keys used in C# code
    ('CreditTransfer:DefaultPIN', '1020', 'Business', 'Default PIN for transfers (from original Web.config)', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:MaximumPercentageAmount', '1', 'Business', 'Maximum percentage amount for balance validation (from original Web.config)', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:SubscriptionTypes', 'friendi-2,TouristSim', 'Business', 'Subscription types for transfer validation (from original Web.config)', 1, GETUTCDATE(), 'System'),
    
    -- MISSING: SMS Configuration (referenced in C# code)
    ('CreditTransfer:A_Party_SMS_EN', 'You have successfully transferred {0} RO to {1}.', 'SMS', 'A-Party SMS message in English', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:B_Party_SMS_EN', 'You have received {0} RO from {1}', 'SMS', 'B-Party SMS message in English', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:A_Party_SMS_AR', 'تم تحويل {0} ر.ع بنجاح إلى الرقم {1}', 'SMS', 'A-Party SMS message in Arabic', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:B_Party_SMS_AR', 'لقد استلمت {0} ريال عماني من {1}', 'SMS', 'B-Party SMS message in Arabic', 1, GETUTCDATE(), 'System'),
    
    -- MISSING: Alternative SMS keys used in C# code without prefix
    ('CreditTransfer:APartySMSEn', 'You have successfully transferred {0} RO to {1}.', 'SMS', 'Alternative A-Party SMS message in English', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:BPartySMSEn', 'You have received {0} RO from {1}', 'SMS', 'Alternative B-Party SMS message in English', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:APartySMSAr', 'تم تحويل {0} ر.ع بنجاح إلى الرقم {1}', 'SMS', 'Alternative A-Party SMS message in Arabic', 1, GETUTCDATE(), 'System'),
    ('CreditTransfer:BPartySMSAr', 'لقد استلمت {0} ريال عماني من {1}', 'SMS', 'Alternative B-Party SMS message in Arabic', 1, GETUTCDATE(), 'System'),
...
PRINT '✅ Added missing DefaultPIN configuration (value: 1020 from original Web.config)'
PRINT '✅ Added missing MaximumPercentageAmount configuration (value: 1 from original Web.config)'
PRINT '✅ Added missing SubscriptionTypes configuration (value: friendi-2,TouristSim from original Web.config)'
PRINT '✅ Added missing SMS configuration keys (A_Party_SMS_EN, B_Party_SMS_EN, A_Party_SMS_AR, B_Party_SMS_AR)'
PRINT '✅ Added alternative SMS keys (APartySMSEn, BPartySMSEn, APartySMSAr, BPartySMSAr)'
PRINT '✅ Added legacy numeric error code keys for backward compatibility'
PRINT '⚠️  NOTE: C# code uses both CreditTransfer: prefixed and non-prefixed keys - both versions added'
PRINT ''
GO 